...
class HomePage extends Component {
    ...
    userInfoSuccess = (res) => {
        ...
        if (res.data.result == Api.ERROR) {
            ...
            // update storage
            Storage.setPhonenumber(res.data.users.user_phoneNumber)
            Storage.setNRIC(res.data.users.nric_passNumber)
    ...
    async componentDidMount() {
        if (this.props.skipUserInfoUpdate != null) {
            ...
            if (await Storage.getFirstLogin() === 'true') {
                ...
                if ( signupDate != '') {
                    var validPromoDate = new Date("Mon Apr 30 2018 10:17:45 GMT+0800 (+08)")
