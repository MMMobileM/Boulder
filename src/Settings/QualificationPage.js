                            ...
                            <View>
                                <Checkbox
                                    ...
                                    onChange={(name, checked) => {
                                        this.setState({ level1Checked: checked })
                                        if ( !checked ) {
                                            return
                                        }
                                        this.refs.na.doCheck( false )
                                    }}
                        ...
                        <View style={ [style.checkboxContainer, Styles.normalPaddingTop] }>
                            <View>
                                <Checkbox
                                    ...
                                    onChange={(name, checked) => {
                                        this.setState({ level2Checked: checked })
                                        if ( !checked ) {
                                            return
                                        }
                                        this.refs.na.doCheck( false )
                        ...
                        <View style={ [style.checkboxContainer, Styles.normalPaddingTop] }>
                            <View>
                                <Checkbox
                                    ...
                                    onChange={(name, checked) => {
                                        this.setState({ level3Checked: checked })
                                        if ( !checked ) {
                                            return
                                        }
                                        this.refs.na.doCheck( false )
                        ...
                        <View style={ [style.checkboxContainer, Styles.normalPaddingTop] }>
                            <View>
                                <Checkbox
                                    ...
                                    onChange={(name, checked) => {
                                        this.setState({ belayChecked: checked })
                                        if ( !checked ) {
                                            return
                                        }
                                        this.refs.na.doCheck( false )
                        ...
                        <View style={ [style.checkboxContainer, Styles.normalPaddingTop] }>
                            <View>
                                <Checkbox
                                    ...
                                    onChange={(name, checked) => { 
                                        this.setState({ leadChecked: checked }) 
                                        if ( !checked ) {
                                            return
                                        }
                                        this.refs.na.doCheck( false )
                        ...
                        <View style={ [style.checkboxContainer, Styles.normalPaddingTop] }>
                            <View>
                                <Checkbox
                                    ...
                                    onChange={(name, checked) => { 
                                        this.setState({ otherChecked: checked }) 
                                        if ( !checked ) {
                                            return
                                        }
                                        this.refs.na.doCheck( false )
                        ...
                        <View style={ [style.checkboxContainer, Styles.normalPaddingTop] }>
                            <View>
                                <Checkbox
                                    ...
                                    onChange={(name, checked) => {
                                        this.setState({ naChecked: checked })

                                        if ( !checked ) {
                                            return
                                        }
                                        this.refs.level1.doCheck( false )
                                        this.refs.level2.doCheck( false )
                                        this.refs.level3.doCheck( false )
                                        this.refs.belay.doCheck( false )
                                        this.refs.other.doCheck( false )
                                        this.refs.lead.doCheck( false )
                                    } }
                                    style={{backgroundColor: 'white', color:'#696969', borderWidth: 1}}
                                    size={moderateScale(25)}
                                    ref='na'
